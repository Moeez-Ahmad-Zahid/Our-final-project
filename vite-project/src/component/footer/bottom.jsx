    ...
    <footer className="bg-dark text-light py-4">
      <Container>
        <Row>
          ...
          <Col className="col-3">
            ...
            <div className="d-flex gap-2">
              <a href="#" className="text-light fs-5"><FontAwesomeIcon icon="fa-brands fa-twitter" /></a>
              <a href="#" className="text-light fs-5"><FontAwesomeIcon icon="fa-brands fa-facebook" /></a>
              <a href="#" className="text-light fs-5"><FontAwesomeIcon icon="fa-brands fa-youtube" /></a>
              <a href="#" className="text-light fs-5"><FontAwesomeIcon icon="fa-brands fa-linkedin" /></a>
            </div>
          </Col>
        ...
        <Row className="mt-4 border-top pt-3 text-center">
          <Col>
            <p>© PakClassified, All Rights Reserved. Designed by <span className="text-info">Team EVS</span></p>
            <div>
